...
# Function: Determine the optimal casing of a given input string to facilitate NER and spellchecking
...
def getScore(prevToken, possibleToken, nextToken, wordCasingLookup, uniDist, backwardBiDist, forwardBiDist, trigramDist):
    ...
    denominator = 0
    if possibleToken.lower() in wordCasingLookup:   
